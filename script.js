...
const gameboard = (() => {
    ...
    const chooseName = () => {
        ...
        name_card1.textContent = player1;
        name_card2.textContent = player2;
    }
...
const Player = input => {
    ...
    const cocherCase = (element, mark) => {
        element.textContent == '' ? element.textContent = mark : console.log('case déjà cochée.');
    };
};
